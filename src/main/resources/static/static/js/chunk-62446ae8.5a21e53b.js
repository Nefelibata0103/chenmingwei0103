    ...
    "2fa5": function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                slot: "reference"
            }, [e._v("批量删除")])], 1)], 1), a("el-form-item", {attrs: {label: "活动名称:"}}, [a("el-input", {
                attrs: {
                    placeholder: "请输入活动名称",
                    size: "small"
                }, model: {
                ...
                attrs: {placeholder: "请输入活动名称"}, model: {
                ...
                attrs: {placeholder: "请输入活动负责人"}, model: {
                ...
                attrs: {placeholder: "请输入活动负责人邮箱"}, model: {
                ...
                attrs: {type: "textarea", placeholder: "请输入活动介绍"},
                model: {
            ...
            name: "GradeManage", data: function () {
                return {
                    ...
                    rules: {
                        name: [{required: !0, message: "请输入活动名称"}, {min: 3, message: "活动名称不能小于3位"}],
                        manager: [{required: !0, message: "请输入活动负责人姓名"}, {min: 2, message: "活动负责人名称不能小于2位"}],
                        email: [{required: !0, message: "请输入活动负责人邮箱"}, {type: "email", message: "不是合法的邮箱格式"}],
                        telephone: [{required: !0, message: "请输入活动负责人电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        introducation: [{required: !0, message: "请输入活动介绍"}, {min: 10, message: "活动介绍至少10位"}]
                    }
                }
            }, mounted: function () {
                this.getList()
